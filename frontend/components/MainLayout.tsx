...
export default function MainLayout({ children, disableScroll = false }: MainLayoutProps) {
    ...
    const renderSidebarContent = () => (
        <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--spacing-md)', flex: '1 1 auto', minHeight: 0, overflowY: 'auto' }}>
            ...
            {isMobile && (
                <div className="surface">
                    <div className="card-head"><h4>Navigace</h4></div>
                    <div style={{ padding: 'var(--spacing-sm)', display: 'flex', flexDirection: 'column', gap: 3 }}>
                        {navItems.map((item) => (
