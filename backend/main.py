...
from routers import accounts, transactions, dashboard, sync, settings, investments, budgets, monthly_budget, categories, manual_accounts, contacts, manual_investments, auth, loans, subscriptions, tags, notifications, cashflow
