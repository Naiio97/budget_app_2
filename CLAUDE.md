...
LOG_LEVEL=INFO   # DEBUG zapne podrobné logy (na Azure stačí změnit env var, bez nové image)
LOG_FORMAT=text  # json = strukturované logy (produkce, nastavuje Dockerfile); text = lokální vývoj
```
